...
def create_Res18():
    return ResNet(BasicBlock, [2,2,2,2], num_classes=2, width_multiplier=1)


def create_Res50():
    return ResNet(Bottleneck, [3,4,6,3], num_classes=2, width_multiplier=1)


# net =ResNet(block=4.0, num_blocks=3.0, num_classes=1000, width_multiplier=1)
# print(net)