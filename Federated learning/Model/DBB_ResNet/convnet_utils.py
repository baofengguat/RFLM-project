...
# def ResNet50(num_classes=2, resolution=(128, 128)):
#     return ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, resolution=resolution)
#
# def ResNet101(num_classes=2, resolution=(128, 128)):
#     return ResNet(Bottleneck, [3, 4, 23, 3],num_classes=num_classes, resolution=resolution)
#
#
# def ResNet152(num_classes=2, resolution=(128, 128)):
#     return ResNet(Bottleneck, [3, 8, 36, 3],num_classes=num_classes, resolution=resolution)
